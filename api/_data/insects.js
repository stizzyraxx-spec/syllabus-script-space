export const INSECTS_DATABASE = {
  locust: {
    name: 'Locust', emoji: '🦗', scientificName: 'Schistocerca gregaria and related species',
  ...
  ant: {
    name: 'Ant', emoji: '🐜', scientificName: 'Formicidae family',
  ...
  bee: {
    name: 'Bee', emoji: '🐝', scientificName: 'Apis mellifica and related species',
  ...
  fly: {
    name: 'Fly', emoji: '🪰', scientificName: 'Musca domestica and related species',
  ...
  moth: {
    name: 'Moth', emoji: '🦋', scientificName: 'Lepidoptera order',
  ...
  worm: {
    name: 'Worm', emoji: '🪱', scientificName: 'Various species',
  ...
  spider: {
    name: 'Spider', emoji: '🕷️', scientificName: 'Arachnida class',
