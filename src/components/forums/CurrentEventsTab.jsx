...
import { RefreshCw, Loader2, ExternalLink, MessageSquare, BookOpen } from "lucide-react";
...
export default function CurrentEventsTab({ onDiscuss }) {
    ...
    <div className="grid lg:grid-cols-3 gap-10">
      ...
      <div className="lg:col-span-2">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="font-display text-xl font-bold text-foreground">Current Events</h2>
            ...
            >
              {events?.map((event, i) => (
                <motion.div
                  ...
                  className="group p-5 rounded-xl border border-border hover:border-accent/30 transition-all duration-300 bg-card"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-display text-base font-bold mb-1 text-foreground group-hover:text-accent transition-colors">
                        {event.headline}
                      </h3>
                      ...
                      <div className="mt-4 flex items-center gap-4 justify-between">
                        <button
                          onClick={() => onDiscuss(event)}
                          className="flex items-center gap-1.5 font-body text-xs font-semibold text-accent hover:text-accent/80 transition-colors border border-accent/30 hover:border-accent/60 px-3 py-1.5 rounded-lg"
                        >
