...
export default function LoginPage() {
  ...
  const handleGoogle = () => {
    ...
    const redirectTo = `${window.location.origin}/auth/callback?redirect=${encodeURIComponent(fromUrl)}`;
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl"
          ...
          <div className="p-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-semibold mb-5 transition-all hover:opacity-90 active:scale-[0.98]"
              style={{ background: "rgba(255,255,255,0.96)", color: "#1e293b" }}
            >
              {googleLoading ? (
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs font-medium" style={{ color: "rgba(255,255,255,0.3)" }}>or continue with email</span>
              <div className="flex-1 h-px" style={{ background: "rgba(212,175,55,0.2)" }} />
            </div>
